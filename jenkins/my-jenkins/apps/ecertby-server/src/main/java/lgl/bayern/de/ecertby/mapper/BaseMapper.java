...
public abstract class BaseMapper<D extends BaseDTO, E extends BaseEntity, Q extends EntityPath<E>> {

  // The Spring Data Repository to use for Entities. This is a dynamic parametrised type resolved
  // in runtime.
  @Autowired
//  @SuppressWarnings("SpringJavaInjectionPointsAutowiringInspection")
          BaseRepository<E, Q> repository;
  ...
  OptionDTO mapUserTypeToOptionDTO(UserType userType) {
    OptionDTO optionDTO = new OptionDTO();
    optionDTO.setName(MessageConfig.getValue(userType.toString()));
    optionDTO.setId(userType.toString());
    return optionDTO;
  }

  UserType mapOptionDTOToUserType(OptionDTO optionDTO) {
    return UserType.getEnum(optionDTO.getId());
  }
