...
import lgl.bayern.de.ecertby.dto.BaseDTO;
import lgl.bayern.de.ecertby.mapper.BaseMapper;
import lgl.bayern.de.ecertby.model.BaseContentEntity;
import lgl.bayern.de.ecertby.model.BaseEntity;
import lgl.bayern.de.ecertby.repository.BaseRepository;
...
@Validated
@Transactional
abstract class BaseService<D extends BaseDTO, E extends BaseEntity, Q extends EntityPath<E>> {

  @Autowired
  @Getter
  private BaseRepository<E, Q> repository;

  @Autowired
  @SuppressWarnings("SpringJavaInjectionPointsAutowiringInspection")
  private BaseMapper<D, E, Q> mapper;
  ...
  public D save(D dto, InputStream file) {
    if (StringUtils.isNotEmpty(dto.getId())) {
      final E entity = (E) ReturnOptional.r(repository.findById(dto.getId()));
  ...
  public boolean activate (Boolean isActive,String id, Class type) {
      return repository.activate(isActive, id, type);
  }

  public boolean release (String id, Class type) {
    return repository.release(id, type);
  }
  public boolean publish (String id, Class type) {
    return repository.publish(id, type);
  }
  public E partialSave(Map<String, Object> fields, String id, Class type){
      return repository.partialSave(fields,id,type);
  }
  ...
  public boolean delete (String id, Class type) {
    return repository.delete(id, type);
  }
